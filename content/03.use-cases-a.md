...
<!-- HW: suggest mentioning size limits on GitHub, as it is an important constraint for this application (e.g. metagenomic data, some large scale model simulations). GitHub docs mention that commits larger than 50 MB recieve a warning sign, and there is a hard block on commits larger than 100 MB.-->
...
<!-- HW: My understanding is that Zendo also allows for storage of larger files? Documentation mentions up to 50 GB per dataset -->
