...
*could link this back to the "Project Management" section or even "Collaborative (code) editing".It actually seems to me like this entire section could potentially be combined with "Collaborative (code) editing"* <!-- HW: I agree, I think that the asynchronus working is better as a part of the Collaborite code editing than as its own section--> 
